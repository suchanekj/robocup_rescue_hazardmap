...
DATASET_FILTERING_STRENGTH_AFFECTS_ZOOM = True
DATASET_FILTERING_STRENGTH_AFFECTS_ROTATION = False
DATASET_FILTERING_STRENGTH_AFFECTS_BLUR_CUT = True
DATASET_FILTERING_STRENGTH_AFFECTS_CROP = True
DATASET_FILTERING_STRENGTH_AFFECTS_COLOUR_FILTER = True
DATASET_FILTERING_STRENGTH_AFFECTS_PERSPECTIVE = True
DATASET_FILTERING_STRENGTH_AFFECTS_DISTORT = True

DATASET_FILTERING_EASY_CHANCE = (0, 0, 0.1, 0.2, 0.3)
DATASET_FILTERING_EASY_MAX_OBJECTS = 2
DATASET_FILTERING_EASY_OBJECTS_SIZE = 2
DATASET_FILTERING_EASY_AFFECTS_ZOOM = True
DATASET_FILTERING_EASY_AFFECTS_ROTATION = False
DATASET_FILTERING_EASY_AFFECTS_BLUR_CUT = False
DATASET_FILTERING_EASY_AFFECTS_CROP = True
DATASET_FILTERING_EASY_AFFECTS_COLOUR_FILTER = False
DATASET_FILTERING_EASY_AFFECTS_PERSPECTIVE = True
DATASET_FILTERING_EASY_AFFECTS_DISTORT = True

MANUAL_DATASET_SIZE = 100
